...
import ZoomComponente from './ZoomComponente';
...
function Mapa() {
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', background: '#eef1f5' }}>
      <div style={{
        position: 'absolute', top: 0, left: 0, right: 0, zIndex: 5, padding: '8px 14px',
        background: '#2b4a6f', color: '#fff', display: 'flex', gap: 12, alignItems: 'center',
        flexWrap: 'wrap',
      }}>
...
export default function MapaComponentes() {
  return <ReactFlowProvider><Mapa /></ReactFlowProvider>;
}
