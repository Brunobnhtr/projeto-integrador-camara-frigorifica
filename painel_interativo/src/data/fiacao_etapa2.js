...
export const FIOS_ETAPA2 = [
  {
    n: 'C1', etapa: 2, nome: 'alimentação da cadeia', classe: 'potencia',
    de: { comp: 'BD-24V', via: 'O2' }, para: { comp: 'S0', via: '11' },
    mm2: 0.5, cor: '#c92a2a', corNome: 'vermelho',
    rota: ['CH-base', 'CV-esq', 'CH-2x1', 'CP-vpot', 'CP-3x4'],
  ...
  {
    n: 'C2', etapa: 2, nome: 'nó CMD → REARME', classe: 'potencia',
  ...
  {
    n: 'C3', etapa: 2, nome: 'nó CMD → selo do KA1', classe: 'potencia',
  ...
  {
    n: 'C4', etapa: 2, nome: 'REARME → bobina do KA1', classe: 'potencia',
    de: { comp: 'S3', via: '14' }, para: { comp: 'KA1', via: 'A1' },
    mm2: 0.5, cor: '#1971c2', corNome: 'azul',
    rota: ['CP-3x4', 'CP-vpot', 'CH-2x1'],
  ...
  {
    n: 'C5', etapa: 2, nome: 'ponte do nó CMD na base do KA1', classe: 'potencia',
    de: { comp: 'KA1', via: '11' }, para: { comp: 'KA1', via: '21' },
    mm2: 0.5, cor: '#c92a2a', corNome: 'vermelho', rota: [],
    diz: 'Ponte curta na própria base PTF08A: os dois contatos do KA1 partem do mesmo nó.',
  },
  {
    n: 'C6', etapa: 2, nome: '⭐ O SELO', classe: 'potencia',
    de: { comp: 'KA1', via: '14' }, para: { comp: 'KA1', via: 'A1' },
    mm2: 0.5, cor: '#f59f00', corNome: 'amarelo', rota: [],
  ...
  {
    n: 'C7', etapa: 2, nome: 'KA1 habilita → STOP', classe: 'potencia',
  ...
  {
    n: 'C8', etapa: 2, nome: 'STOP → bobina do KA2', classe: 'potencia',
    de: { comp: 'S2', via: '12' }, para: { comp: 'KA2', via: 'A1' },
    mm2: 0.5, cor: '#212529', corNome: 'preto',
    rota: ['CP-3x4', 'CP-vpot', 'CH-2x1'],
  ...
  {
    n: 'C9', etapa: 2, nome: 'retorno da bobina do KA1', classe: 'comum',
    de: { comp: 'KA1', via: 'A2' }, para: { comp: 'BD-0V', via: 'R11' },
    mm2: 0.5, cor: '#4dabf7', corNome: 'azul claro',
    rota: ['CH-2x1'],
    diz: 'A bobina fecha no 0 V comum, ponto R11 da barra.',
  },
  {
    n: 'C10', etapa: 2, nome: 'retorno da bobina do KA2', classe: 'comum',
  ...
  {
    n: 'C11', etapa: 2, nome: '24 V comandado → BD-POT', classe: 'potencia',
