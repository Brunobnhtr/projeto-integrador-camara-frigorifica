...
const pot = (n, de, para, mm2, diz, extra = {}) => ({
  n, etapa: 3, classe: 'potencia', mm2, cor: '#c92a2a', corNome: 'vermelho',
  de, para, diz, ...extra,
});
...
const cinco = (n, de, para, diz, extra = {}) => ({
  n, etapa: 3, classe: 'alim', mm2: 0.5, cor: '#f76707', corNome: 'laranja',
  de, para, diz, ...extra,
});
const zero = (n, de, para, diz, extra = {}) => ({
  n, etapa: 3, classe: 'comum', mm2: 0.5, cor: '#4dabf7', corNome: 'azul claro',
  de, para, diz, ...extra,
});
...
export const FIOS_ETAPA3 = [
  ...
  { ...pot('D3', { comp: 'BD-POT', via: 'O3' }, { comp: 'PI1', via: 'J1-11' }, 0.5,
    ...
    classe: 'alim', rota: ['CH-2x1', 'CV-esq', 'CH-3x2'],
  ...
  { ...cinco('D8', { comp: 'BD-5V', via: 'O3' }, { comp: 'RTC', via: 'VCC' },
      'O relógio, que guarda a hora dos ensaios.'), rota: ['CH-2x1'] },
  ...
  { n: 'D14', etapa: 3, classe: 'alim', mm2: 0.75, cor: '#f59f00',
    corNome: 'amarelo', de: { comp: 'BD-AUX', via: 'O1' },
    para: { comp: 'MV-1', via: 'VIN' }, rota: ['CH-2x1'],
  ...
  { ...zero('D16', { comp: 'BTS2', via: 'B−' }, { comp: 'BD-0V', via: 'R2' },
      'Retorno de potência do BTS #2.'), mm2: 1.5, rota: ['CH-2x1'] },
  ...
  { ...zero('D19', { comp: 'MEGA', via: 'GND3' }, { comp: 'BD-0V', via: 'R5' },
      'O 0 V do Arduino.'), rota: ['CH-2x1', 'CV-esq', 'CH-3x2'] },
  ...
  { ...zero('D21', { comp: 'ESP32', via: '−' }, { comp: 'BD-0V', via: 'R7' },
      'Retorno do DNLCB30.'), rota: ['CH-2x1'] },
  { ...zero('D22', { comp: 'RTC', via: 'GND' }, { comp: 'BD-0V', via: 'R8' },
      'Retorno do relógio.'), rota: ['CH-2x1'] },
  { ...zero('D23', { comp: 'MV-1', via: 'GND' }, { comp: 'BD-0V', via: 'R13' },
      'Retorno das CARGAS do MV-1 — o lado dos 12 V.'), rota: ['CH-2x1'] },
