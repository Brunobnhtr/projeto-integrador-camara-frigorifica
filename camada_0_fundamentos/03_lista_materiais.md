...
| ⭐ **DS18B20 à prova d'água** ⬆ | **+1** | **Sobe de 1 para 2.** O segundo vai colado no dissipador do lado quente, para o firmware saber quando pode desligar a ventoinha. ⚠️ **Não gasta pino:** 1-Wire é barramento, os dois vão no mesmo fio | |
